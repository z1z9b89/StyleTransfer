...
from datasets import CyberDataset, TestDataset
...
class BaseModel(object):
    ...
    def train(self):
        ...
        for epoch in range(self.options.epochs):
            ...
            for input_rgb in generator:
                ...
                feed_dic = {self.input_rgb: originItems,self.input_gray:sketchItems.reshape(self.options.batch_size,512,512,1)}
    ...
    def sample(self, show=True):
        ...
        feed_dic = {self.input_rgb: input_rgb[0],self.input_gray:input_rgb[1]}
...
class CyberModel(BaseModel):
    def __init__(self, sess, options):
        super(CyberModel, self).__init__(sess, options)
